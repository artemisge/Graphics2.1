...
void OnMouseMove(int xPosition, int yPosition)
{
   if (selectPoint > -1)
   {
      ...
      if (p.ptype[selectPoint] == 0)
      { // End point
         p.ctrlPoints[selectPoint][0] = newX;
         p.ctrlPoints[selectPoint][1] = newY;
      }
      else if (p.ptype[selectPoint] == 1)
      { // Dependent point
         if (p.ptype[selectPoint - 1] == 2)
         { // look back, check for connect point
            // move itself
            p.ctrlPoints[selectPoint][0] = newX;
            p.ctrlPoints[selectPoint][1] = newY;
            ...
            p.ctrlPoints[selectPoint - 2][0] = (2 * p.ctrlPoints[selectPoint - 1][0]) - p.ctrlPoints[selectPoint][0];
            p.ctrlPoints[selectPoint - 2][1] = (2 * p.ctrlPoints[selectPoint - 1][1]) - p.ctrlPoints[selectPoint][1];
         }
         else if (p.ptype[selectPoint + 1] == 2)
         { // Look next, check for connect point
            // move itself
            p.ctrlPoints[selectPoint][0] = newX;
            p.ctrlPoints[selectPoint][1] = newY;
         ...
         { // back and next are either dependent or end points
            p.ctrlPoints[selectPoint][0] = newX;
            p.ctrlPoints[selectPoint][1] = newY; 
         }
      }
      else if (p.ptype[selectPoint] == 2)
      { // Connect point
         // move itself
         p.ctrlPoints[selectPoint][0] = newX;
         p.ctrlPoints[selectPoint][1] = newY;
